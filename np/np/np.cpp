// np.cpp : Defines the entry point for the console application.
//
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	char* filename = "D:\\Adiel\\ECUADOR\\NUMBERPLATE\\np\\test\\3732FWW.jpg";
	Mat input_image;

	//Check if user specify image to process
	/*if (argc >= 2)
	{*/
		//filename = "a.jpg"; // argv[1];
	...
	//Read file storage.
	FileStorage fs;
	fs.open("D:\\Adiel\\ECUADOR\\NUMBERPLATE\\np\\SVM.xml", FileStorage::READ);
	...
	OCR ocr("D:\\Adiel\\ECUADOR\\NUMBERPLATE\\np\\OCR.xml");
